...
# Insert new values into mmtlogs:wfs_seeing_log MySQL table
my $fits_with_path = '/mmt/wfsdat/' . $year . $month. $day . '/';
$fits_with_path .= $fits;
insert2mysql($data->fhdr->{DATE}, $exptime, $az, $el, $rot, $airmass, $psf, $see_as, $mode, $fits_with_path);  
...
sub insert2mysql {
    # inputs:
    # d:    = '2011-05-27T08:28:08' / Date FITS file was generated
    ...
    my ($d, $exptime, $az, $el, $rot, $airmass, $psf, $see_as, $mode, $fits_file) = @_;
    ...
    if ($mysql) {
        ...
        # Replace the "T" in the Header DATA field with a space.
        $d =~ s/T/ /;   
    	...
    	$query .= "DATE_SUB(" . $mysql->quote($d) . ", INTERVAL 7 HOUR), ";
