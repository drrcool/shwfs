...
proc WFSSERV.centroid { s sock msgid cmd list } {
    ...
    #set command "$bin_dir/daofind.py $list $fmode 0 &> /tmp/evil.log"
	...
	if {[regexp {\.dao} $line]} {
	    ...
	    if { $spotcount < 97 } {
	        ...
	        set messg "image;text 250 500 # text={$spotcount spots linked, Game Over!}"
	    }
	    exec echo $messg | xpaset WFS regions"
	} 
    }   
