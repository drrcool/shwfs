...
set sffile ${rfile}.dao ; # raw daophot output
...
eval exec "$env(WFSROOT)/mkpupmask.pl $reference > f5pupmask.org"
...
if {[lindex $line 1] == "X"} {
    ...
    set XCR [lindex $line 4]
    set YCR [expr 512 - [lindex $line 5]]
} else {
    set XCR 262 
    set YCR [expr 512 - 258]
    set RMAG 14.1
}
...
# the coords saved in f5pupmask.org, then use canvas math to convert it to
# the last-saved geometry

set maskID [open "f5pupmask.org" r]
