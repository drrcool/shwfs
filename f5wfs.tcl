...
set tok [dns::resolve _waveserv._tcp.mmto.arizona.edu -type SRV]
set res [dns::result $tok]
set port [lindex [lindex [lindex $res 0] 11] 5]
set host [lindex [lindex [lindex $res 0] 11] 7]
set env(WAVESERV) $host:$port

set tok [dns::resolve _wavecamr._tcp.mmto.arizona.edu -type SRV]
set res [dns::result $tok]
set port [lindex [lindex [lindex $res 0] 11] 5]
set host [lindex [lindex [lindex $res 0] 11] 7]
#set env(WAVEWFS) $host:$port
set env(WAVEWFS) localhost:$port

set tok [dns::resolve _wavesci._tcp.mmto.arizona.edu -type SRV]
set res [dns::result $tok]
set port [lindex [lindex [lindex $res 0] 11] 5]
set host [lindex [lindex [lindex $res 0] 11] 7]
set env(WAVESCI)  $host:$port

set tok [dns::resolve _wavepix._tcp.mmto.arizona.edu -type SRV]
set res [dns::result $tok]
set port [lindex [lindex [lindex $res 0] 11] 5]
set host [lindex [lindex [lindex $res 0] 11] 7]
set env(WAVEPIX)  $host:$port
